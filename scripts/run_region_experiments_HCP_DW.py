...
def train_encoder(args):
    ...
    best_gain = 0
    current_gain=0
    tr_sub_SZ = [15, 25, 50, 75, 425, 125] #142
    tr_sub_HC = [15, 25, 50, 75, 329, 125] #134
    ...
    ntest_samples_perclass_SZ = 53
    ntest_samples_perclass_HC = 41
    if ID == 5:
        nval_samples_perclass = 15
    else:
        nval_samples_perclass_SZ = 53
        nval_samples_perclass_HC = 41
    test_start_index = 0
    ...
    if torch.cuda.is_available():
        ...
        device_extra = torch.device("cuda:3")
    ...
    all_labels = all_labels.view(752)
    ...
    all_labels = torch.cat((all_labels,all_labels2),dim=0).int()
